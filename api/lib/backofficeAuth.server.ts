...
import { extractBearerToken } from '../lib/adminAuth.server.js';
import { createSupabaseAuthVerifier, createSupabaseServiceRoleClient } from '../lib/supabaseAdmin.server.js';
import {
