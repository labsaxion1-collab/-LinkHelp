...
const BLUE: ChatHeroAccentTheme = {
  backgroundKey: 'blue',
  bandBase: 'bg-[#020817]',
  bandOverlay: 'bg-[radial-gradient(circle_at_72%_50%,rgba(59,130,246,0.30),transparent_42%),linear-gradient(90deg,rgba(0,5,18,0.95)_0%,rgba(2,18,46,0.80)_55%,rgba(0,5,18,0.94)_100%)]',
  statusText: 'text-blue-300/80',
  chipChevron: 'text-blue-300/75',
  chipAccentText: 'text-blue-300/85',
  chipBackdrop: 'bg-[#020817]/45',
  serviceOverlay: 'bg-[#020817]/45',
  serviceCta: 'border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100',
  sendActive: 'border border-blue-400/45 bg-[#020817] text-blue-200 shadow-[0_4px_18px_rgba(59,130,246,0.42),inset_0_1px_0_rgba(255,255,255,0.12)] active:scale-95',
  sendInactive: 'border border-blue-400/25 bg-[#020817] text-blue-300/45',
  sendGlow: 'bg-[radial-gradient(circle_at_28%_18%,rgba(147,197,253,0.30),transparent_58%)]',
  sendIconActive: 'text-blue-100 drop-shadow-[0_0_8px_rgba(147,197,253,0.55)]',
  sendIconInactive: 'text-blue-300/75',
