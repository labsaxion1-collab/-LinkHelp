      ...
      <div className="relative z-10 px-3 pb-3 pt-5 sm:px-8 sm:pb-5 sm:pt-7">
        ...
        <div className="mx-auto mt-2 flex w-full max-w-[33rem] flex-col sm:mt-3">
          ...
          <div className="flex items-center justify-center py-5 sm:py-7">
            <div className="lh-hero-level-pill w-fit rounded-full border border-amber-300/40 bg-amber-400/10 px-5 py-1.5 shadow-[0_0_22px_rgba(251,191,36,0.20)] backdrop-blur-md">
              <p className="text-sm font-black uppercase tracking-[0.08em] text-amber-200 sm:text-base">
                {visual.currentLevel}
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto w-fit -translate-y-2">
          <span className="lh-hero-nivel-badge-gold inline-flex min-w-[7.5rem] justify-center rounded-full border border-amber-200/45 bg-gradient-to-b from-amber-300 via-amber-500 to-amber-900 px-4 py-1 text-sm font-black text-amber-950 shadow-[0_0_18px_rgba(251,191,36,0.24)] sm:min-w-[9rem] sm:text-base">
            {visual.levelLabel}
          </span>
        </div>
        ...
        <div className="lh-hero-progress mx-auto mt-3 max-w-[45rem] rounded-2xl border border-amber-300/20 bg-amber-950/25 px-3 py-2.5 shadow-[0_8px_32px_rgba(251,191,36,0.12)] backdrop-blur-lg sm:px-5">
          <div className="flex items-center gap-2.5">
            <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-amber-300/30 bg-amber-400/15 text-amber-300">
              <ShieldCheck className="h-5 w-5" />
            </span>
            <div className="min-w-0 flex-1">
              <p className="text-[10px] text-white/65 sm:text-xs">{visual.nextLevelLabel}</p>
              <p className="truncate text-xs font-black uppercase text-amber-400 sm:text-base">
                {visual.nextLevel}
              </p>
            </div>
          ...
          <div className="mt-2 h-2 overflow-hidden rounded-full bg-white/[0.07]">
            <span
              className="block h-full rounded-full bg-gradient-to-r from-amber-700 via-amber-400 to-yellow-200 shadow-[0_0_14px_rgba(251,191,36,0.42)]"
