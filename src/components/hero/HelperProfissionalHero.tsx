...
export function HelperProfissionalHero({ balance }: Props) {
  ...
  return (
    <section className="relative left-1/2 isolate mb-4 w-[100dvw] max-w-none -translate-x-1/2 overflow-hidden border-0 bg-[#09020b] text-white shadow-none ring-1 ring-fuchsia-500/15 lg:left-auto lg:w-full lg:translate-x-0 lg:rounded-[1.75rem] lg:shadow-[0_22px_58px_rgba(45,0,55,0.34)]">
      <img
        src={backgroundImage}
        alt=""
        aria-hidden="true"
      ...
      <div className="relative z-10 px-3 pb-3 pt-5 sm:px-8 sm:pb-5 sm:pt-7">
        <header className="flex items-center justify-between gap-3">
          <p className="lh-hero-tag inline-flex min-w-0 items-center gap-1.5 text-[9px] font-black uppercase tracking-[0.13em] text-fuchsia-200 sm:text-xs sm:tracking-[0.18em]">
          ...
          <div className="lh-hero-balance flex min-w-0 items-center">
            <div className="flex min-w-0 items-center gap-1.5 rounded-full border border-fuchsia-300/25 bg-fuchsia-950/35 px-2 py-1.5 backdrop-blur-md sm:min-w-[15rem] sm:gap-3 sm:px-5 sm:py-2.5">
              <img
        ...
        <div className="mx-auto mt-2 flex w-full max-w-[33rem] flex-col sm:mt-3">
          ...
          <div className="flex items-center justify-center py-5 sm:py-7">
            <div className="lh-hero-level-pill w-fit rounded-full border border-fuchsia-300/35 bg-fuchsia-500/10 px-5 py-1.5 shadow-[0_0_22px_rgba(217,70,239,0.20)] backdrop-blur-md">
              <p className="text-sm font-black uppercase tracking-[0.08em] text-fuchsia-100 sm:text-base">
                {visual.currentLevel}
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto w-fit -translate-y-2">
          <span className="lh-hero-nivel-badge-magenta inline-flex min-w-[7.5rem] justify-center rounded-full border border-fuchsia-200/40 bg-gradient-to-b from-fuchsia-300 via-fuchsia-500 to-purple-950 px-4 py-1 text-sm font-black sm:min-w-[9rem] sm:text-base">
            {visual.levelLabel}
          </span>
        </div>
        ...
        <div className="lh-hero-progress mx-auto mt-3 max-w-[45rem] rounded-2xl border border-fuchsia-300/20 bg-fuchsia-950/30 px-3 py-2.5 shadow-[0_8px_32px_rgba(217,70,239,0.13)] backdrop-blur-lg sm:px-5">
          <div className="flex items-center gap-2.5">
            <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-fuchsia-300/25 bg-fuchsia-500/15 text-fuchsia-200">
              <ShieldCheck className="h-5 w-5" />
            </span>
            <div className="min-w-0 flex-1">
              <p className="text-[10px] text-white/65 sm:text-xs">{visual.nextLevelLabel}</p>
              <p className="truncate text-xs font-black uppercase text-fuchsia-300 sm:text-base">
                {visual.nextLevel}
              </p>
            </div>
          ...
          <div className="mt-2 h-2 overflow-hidden rounded-full bg-white/[0.07]">
            <span
              className="block h-full rounded-full bg-gradient-to-r from-purple-700 via-fuchsia-500 to-fuchsia-200 shadow-[0_0_14px_rgba(217,70,239,0.42)]"
