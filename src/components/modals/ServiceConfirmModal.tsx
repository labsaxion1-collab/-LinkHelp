...
export function ServiceConfirmModal({ open, job, busy, onConfirm, onDismiss, onReportProblem, t }: Props) {
      ...
      <div className="mt-6 flex flex-col gap-2">
        ...
        {onReportProblem ? (
          <button
            ...
            className="min-h-[44px] rounded-xl border border-amber-200 bg-amber-50 px-4 text-sm font-bold text-amber-900 hover:bg-amber-100 disabled:opacity-60"
          >
