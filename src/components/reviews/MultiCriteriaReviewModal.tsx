    ...
    <LhModal open={open} onClose={handleClose} title={t(titleKey)} size="md">
      <div className="space-y-3">
        <div className="flex items-center gap-2.5 rounded-xl border border-slate-100 bg-slate-50 p-2.5">
          <img src={pending.targetAvatar} alt="" className="h-10 w-10 rounded-lg object-cover ring-2 ring-white" />
        ...
        <label className="block">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-800 outline-none focus:border-blue-500"
          />
        </label>
