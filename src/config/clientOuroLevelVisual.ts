export const CLIENT_OURO_LEVEL_VISUAL = {
  id: 'client-ouro',
  accountType: 'client',
  level: 3,
  currentLevel: 'Cliente Ouro',
  levelLabel: 'Nivel 3',
  nextLevel: '4. Cliente VIP',
  progressPercent: 42,
  pointsRemaining: 420,
  ...
  journeyEyebrow: 'Sua excelencia ganhou destaque',
  headline: {
    beforeHighlight: 'Sua reputacao agora vale',
    highlight: 'ouro.',
  },
  description:
    'Sua constancia transformou confianca em reconhecimento. Continue criando boas experiencias para chegar ao nivel VIP.',
  balanceLabel: 'Saldo disponivel',
  nextLevelLabel: 'Proximo nivel',
  medalAlt: 'Medalha Cliente Ouro',
} as const;

export const CLIENT_OURO_SPARKLES = [
...
export type ClientOuroLevelVisual = typeof CLIENT_OURO_LEVEL_VISUAL;
