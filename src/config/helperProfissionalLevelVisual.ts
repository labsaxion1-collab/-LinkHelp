export const HELPER_PROFISSIONAL_LEVEL_VISUAL = {
  ...
  journeyEyebrow: 'Sua experiencia inspira confianca',
  headline: {
    beforeHighlight: 'Excelencia que transforma talento em',
    highlight: 'reconhecimento.',
  },
  description:
    'Seu trabalho ja se destaca. Continue entregando qualidade, conquistando avaliacoes e fortalecendo sua presenca profissional.',
