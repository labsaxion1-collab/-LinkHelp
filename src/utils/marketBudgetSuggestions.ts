...
const SUGGESTIONS: Record<ServiceCategoryId, SuggestionMap> = {
  ...
  design: {
    logo_brand: { min: 150, max: 400 },
    social_media: { min: 60, max: 150 },
    ui_ux: { min: 200, max: 600 },
    print: { min: 80, max: 200 },
    presentation: { min: 70, max: 180 },
    photo_editing: { min: 50, max: 130 },
    default: { min: 80, max: 220 },
  },
  marketing: {
    social_media: { min: 80, max: 200 },
    seo: { min: 120, max: 350 },
    paid_ads: { min: 100, max: 300 },
    content: { min: 60, max: 180 },
    email: { min: 90, max: 220 },
    branding: { min: 150, max: 450 },
    default: { min: 90, max: 250 },
  },
  other: {
