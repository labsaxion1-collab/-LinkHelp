-- Paste this entire file in Supabase Dashboard → SQL Editor if candidatura returns 404 on:
--   /rest/v1/applications
--   /rest/v1/rpc/ensure_conversation
--   /rest/v1/rpc/helper_debit_application_interest
