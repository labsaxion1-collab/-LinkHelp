...
-- Staging is missing the completion RPCs the app already calls:
...
-- Source of truth: supabase/baseline_drafts/staging/packs/60_service_completion_workflow.sql
-- Does NOT change LinkCredits / VIP formulas / hire pricing.
-- Idempotent: already-completed returns alreadyCompleted=true without double rewards.
-- =============================================================================
